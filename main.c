...
/*   Updated: 2024/08/21 12:20:24 by aumoreno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_move_right(t_data *img_to_move)
{
	ft_printf("Hello!\n");
	mlx_put_image_to_window(mlx_data.mlx, mlx_data.mlx_win, character_img.img_ptr, 100, 100);
...
int main(void)
{
	...
	mlx_hook(mlx_data.mlx_win, 2, 1L<<0,&ft_move_right, &character_img);	
